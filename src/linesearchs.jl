...
function LSI(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    ϵ = 1e-6
...
function LSII(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    ϵ = 1e-6
    return (dk::Vector{Float64}, xk::Vector{Float64}; params::LSParams) -> begin
        max_iters = 10_000
        for i in 0:max_iters
...
function LSIII(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    ϵ = 1e-6
    return (dk::Vector{Float64}, xk::Vector{Float64}; params::LSParams) -> begin
        max_iters = 10_000
        for i in 0:max_iters
...
function LSIV(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    b = zeros(maxitrs + 1)
...
function LSV(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    ϵ = 1e-6
    return (dk::Vector{Float64}, xk::Vector{Float64}; params::LSParams) -> begin
        max_iters = 10_000
        for i in 0:max_iters
...
function LIX(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    ϵ = 1e-6
    η = 0.001
    ξ = 0.6
...
function LSVI(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    LIX(F, maxitrs, β, σ)
end

function LSVII(F::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
    sd_fun = LIX(F, maxitrs, β, σ)
    return (d::Vector{Float64}, u::Vector{Float64}; params::LSParams) -> begin
        k = params.k
...
"""
function LSVIII(evalFun::Function, maxitrs::Int, β::Float64=0.5, σ::Float64=0.001)
...
function getAllLineSearch()
    return [LSI, LSII, LSIII, LSIV, LSV, LSVI, LSVII, LSVIII, LIX]
end